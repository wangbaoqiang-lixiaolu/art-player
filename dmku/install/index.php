...
<title>安装向导_MizhiPlayer 觅知弹幕播放器</title>
...
<nav class="navbar navbar-default" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="#">MizhiPlayer 觅知弹幕播放器安装程序 - www.98dou.cn</a>
        </div>
        <div class="collapse navbar-collapse" id="example-navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="index.php"><span class="glyphicon glyphicon-list-alt"></span>安装首页</a></li>
                <li><a href="https://www.98dou.cn/4973.html" target="_blank"><span class="glyphicon glyphicon-refresh"></span>更新播放器</a></li>
                <li><a href="https://www.98dou.cn/" target="_blank"><span class="glyphicon glyphicon-globe"></span>觅知博客</a></li>
...
<div class="panel panel-primary">
	<div class="panel-heading" style="background: #15A638;">
		<h3 class="panel-title" align="center">欢迎使用MizhiPlayer 觅知弹幕播放器</h3>
	</div>
	...
	if(!$dbconfig['user']||!$dbconfig['pwd']||!$dbconfig['dbname']) {
		...
		if(!$con=DB::connect($dbconfig['host'],$dbconfig['user'],$dbconfig['pwd'],$dbconfig['dbname'],$dbconfig['port'])){
			...
			if(DB::query('SELECT * FROM danmaku_config WHERE 1')==FALSE)
				...
				echo '<div class="list-group-item list-group-item-info">系统检测到你已安装过MizhiPlayer 觅知弹幕播放器</div>
...
?>";
		if(!$con=DB::connect($db_host,$db_user,$db_pwd,$db_name,$db_port)){
			...
			if(DB::query('SELECT * FROM danmaku_config WHERE 1')==FALSE)
				...
				echo '<div class="list-group-item list-group-item-info">数据库配置文件保存成功，MizhiPlayer 觅知弹幕播放器</div>
				<div class="list-group-item">
					<a href="?do=4" onclick="if(!confirm(\'全新安装将会清空所有数据库，是否继续？\')){return false;}" class="btn btn-block btn-info">全新安装</a>
				</div>
				
				<div class="list-group-item">
					<a href="?do=5" class="btn btn-block btn-warning">跳过安装</a>
				</div>';
		}else
...
<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title" align="center">觅知弹幕播放器安装完成</h3>
	</div>
<div class="progress progress-striped">
  <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 100%">
	...
	<div class="panel-body">
<?php
	@file_put_contents("install.lock",'MizhiPlayer弹幕ART播放器安装锁 觅知博客www.98dou.cn');
	echo '<div class="alert alert-info"><font color="green">安装完成！</font><br/><br/><a href="../../">>>播放器首页</a><br/><a href="../../admin">>>管理员后台</a><hr/><font color="blue"></font><br/>提示：更多设置选项请登录后台管理进行修改。<br/><br/><font color="#FF0033">如果你的空间不支持本地文件读写，请自行在install/ 目录建立 install.lock 文件！</font></div>';
?>
	</div>
</div>
